...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
      <link rel="stylesheet" type="text/css" href="main.css"><!--css file-->
       <style type="text/css">
    ...
    <body>
        ...
        <br>
    <div class="container">
          <h3><b><font color="skyblue">Honors</font></b></h3>
        <div class="row">
        <div class="col-md-4">
            <ul><li><font id="title">Presented a Technical Research paper on ENGINEERING APPLICATION OF HAM RADIO</font><br>sep 2016</li></ul>
        </div>
            <div class="col-md-4">
                <ul><li><font id="title">Selected for BOEING IIT Kanpur Aeromodelling Workshop</font></li></ul>
            </div>
            <div class="col-md-4">
                <ul><li><font id="title">Winner of Debate Competetion on Matribhasha Diwas 2016</font></li></ul>
            </div>
        </div>
        <br>
        </div>
