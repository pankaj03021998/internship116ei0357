...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <font><b color="blue">National Institute of Technology Hamirpur</b></font><br>Bachelor of Technology,Electronics and Communications Engineering,7.86<br>2015-2020<br><br>Activites and Societies:Hindi Samiti<br>Hamirpur,Abhyuday,NSS,Student counselling cell,SPIC MACAY<br><br>Executive Memeber at Abhyuday - Abhyuday NIT Hamirpur<br>Executive Member at Hindi Samiti NIT Hamirpur<br>Core Member at SPIC MACAY-NIT Hamirpur(The Society for the promotion of Indian Classical Music and Culture Amongest Youth)<br>Published a Technical Research Paper in ISTE ANNUAL CONVENTION-UDBHAVA-2016 on the topic Enigneering & Digital Applications of HAM Radio.<br>
                    1st prize winner of debate competition of Abhuyday 2015<br>1st prize winner of debate competition on matribhasa diwas at NITH
                </div>
                <div class="col-md-4">
                    <font id="title"><b>K.P.H.S Shilhauri Saran</b></font><br>High School,78%<br>2010 - 2012
                </div>
                <div class="col-md-4">
                    <font id="title"><b>Tapeshwar singh college chapra</b></font>
                </div>
            </div>
        </div>
        <br>
